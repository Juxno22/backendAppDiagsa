...
async function createUser(userData) {
    ...
    try {
        ...
        if (
            userData.sueldo_bruto !== undefined &&
            userData.sueldo_bruto !== null &&
            userData.sueldo_bruto !== ""
        ) {
        ...
        const sueldoBruto = userData.sueldo_bruto
            ...
            : userData.sueldo
                ? Number(userData.sueldo)
                : null;
        const fondoAhorro = sueldoBruto
        ...
        `,
            [
                ...
                userData.es_padre_madre || null,
                userData.fecha_contrato_indeterminado_3m || null,
                userData.talla_playera || null,
                userData.talla_pantalon || null,
                userData.talla_calzado || null,
                userData.talla_faja || null,
                userData.talla_guantes || null,
                userData.numero_cuenta || null,
                userData.clabe_interbancaria || null,
                userData.codigo_postal || null,
                userData.infonavit || null,
                userData.fonacot || null,
                userData.emergencia_nombre || null,
                userData.emergencia_telefono || null,
                userData.emergencia_parentesco || null,
                userData.domicilio_calle || null,
                userData.domicilio_colonia || null,
                userData.domicilio_localidad || null,
                userData.domicilio_cp || null,
                userData.domicilio_num_ext || null,
                userData.domicilio_num_int || null,
                userData.domicilio_municipio || null,
                userData.domicilio_estado || null,
        ...
        // Guardar descuentos
        if (Array.isArray(userData.descuentos)) {
            for (const d of userData.descuentos) {
                if (
                    !d.concepto ||
                    d.monto === undefined ||
                    d.monto === null ||
